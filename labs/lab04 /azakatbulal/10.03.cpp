/* ствоприти клас людина: ім'я прізвише вік пошта, 
створити клас працівник, який агрегує в себе клас людини
створити enum посада, 
створити клас університет, який має список працівників,
в класі працівникиів створити метод фільтру який приймає в себе string імені, enum посади, 
повертає список працівників які підходять під задані параметри
*/
